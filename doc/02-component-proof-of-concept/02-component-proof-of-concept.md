...
I will be picking my Fridge design. I think that in terms of execution, implementation, and novelty,
I find fridge to be the best, as the core concept is simple and not overly complicated in it's rules, and I get to be flexibile with the functionalities of the fridge. I think that the seasonal anime tracker is a bit too specific and complex in it's true functionality and direction, and my subway tracker needs more refining in order to be a better proof of concept. Overall, I believe that my fridge component will bring me great success while allowing me to mess with kernel and secondary methods.
